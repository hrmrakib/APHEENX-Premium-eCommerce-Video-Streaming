    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="h-[250px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={salesData} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
                ...
                <XAxis dataKey="name" axisLine={true} tickLine={true} tick={{ fill: '#000', fontSize: 12 }} stroke="#000" />
                <YAxis axisLine={true} tickLine={true} tick={{ fill: '#000', fontSize: 12 }} stroke="#000" />
                <Line 
                  type="monotone" 
                  dataKey="value" 
                  stroke="#3b82f6" 
        ...
        <div className="bg-white rounded-xl p-6">
          <h2 className="text-black font-semibold text-sm mb-6">Video Performance</h2>
          <div className="h-[250px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={videoPerformanceData} margin={{ top: 5, right: 20, bottom: 5, left: 0 }} barSize={60}>
                <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#eee" />
                <XAxis dataKey="name" axisLine={true} tickLine={true} tick={{ fill: '#888', fontSize: 12 }} stroke="#ccc" />
                <YAxis axisLine={true} tickLine={true} tick={{ fill: '#888', fontSize: 12 }} stroke="#ccc" />
