...
export default function OrdersPage() {
  ...
  // Pass page to your query if your API supports it
  const { data: orderData, isLoading } = useGetMyOrdersQuery({
    page: currentPage,
  });

  const orders: Order[] = orderData?.data || [];
  // Adjust 'totalPages' based on your actual API metadata (e.g., orderData.total_pages)
  const totalPages = orderData?.total_pages || 1;
