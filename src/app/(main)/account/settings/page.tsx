        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="card-border bg-surface/50 p-6 max-w-lg">
            <div className="space-y-5">
              ...
              <button onClick={handleSave} className={`py-3 px-8 rounded-lg text-sm font-semibold transition-all ${saved ? "bg-success text-white" : "gold-gradient text-black hover:shadow-lg hover:shadow-gold/20"}`}>
