                ...
                >
                  <div className='card-border bg-surface/50 overflow-hidden transition-all group-hover:border-gold/40'>
                    <div className='relative aspect-video overflow-hidden bg-surface'>
                      ...
                      />
                      <span className='absolute left-3 top-3 rounded-md bg-success/90 px-2.5 py-1 text-[10px] font-bold text-white'>
                        Owned
                      </span>
                    </div>
                    <div className='p-4'>
                      <span
                        className={`inline-block rounded-md border px-2 py-0.5 text-[10px] font-semibold ${categoryColors[video.category] || "border-border text-muted"}`}
                      >
                        {video.category.charAt(0).toUpperCase() +
                          video.category.slice(1)}
                      </span>
                      <h3 className='mt-2 text-lg font-bold text-foreground italic'>
                        {video.title}
                      </h3>
