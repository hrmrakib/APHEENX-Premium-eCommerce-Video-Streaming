...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
          ...
          <div className="relative flex min-h-[500px] items-center py-16 md:min-h-[600px]">
            ...
            <div className="relative z-10 max-w-xl px-4 md:px-8">
              ...
              <p className="mt-4 text-sm text-muted leading-relaxed md:text-base max-w-md">
                Discover premium fashion and exclusive video content. Your one-stop luxury streaming platform.
              </p>
              <div className="mt-8 flex flex-wrap gap-3">
                <Link href="/shop" className="btn-gold flex items-center gap-2 text-sm">
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10">
          <div className="flex flex-col items-center gap-1 animate-bounce">
            <svg className="h-5 w-5 text-gold/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Newest Videos */}
      <section className="mx-auto max-w-7xl px-4 pb-16 pt-12 lg:px-8">
