      ...
      <div className='mt-6'>
        ...
        <div className='mt-6 flex flex-wrap gap-3'>
          ...
          <button
            ...
            className={`flex items-center gap-2 rounded-lg border px-6 py-3 text-sm font-semibold transition-all ${inWishlist ? "border-gold bg-gold/10 text-gold" : "border-border text-muted hover:border-gold/30 hover:text-foreground"}`}
          >
            <svg
              className='h-4 w-4'
